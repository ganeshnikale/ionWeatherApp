...
var FavoritePalcesPageModule = /** @class */ (function () {
    function FavoritePalcesPageModule() {
    }
    ...
    return FavoritePalcesPageModule;
}());
...
var FavoritePalcesPage = /** @class */ (function () {
    function FavoritePalcesPage(favoriteService) {
        this.favoriteService = favoriteService;
    }
    FavoritePalcesPage.prototype.ngOnInit = function () {
        this.Fplaces = this.favoriteService.favoritePlace;
    };
    FavoritePalcesPage.ctorParameters = function () { return [
...
//# sourceMappingURL=favorite-palces-favorite-palces-module-es5.js.map