...
var map = {
	...
	"./places/place-detils/place-detils.module": [
	...
	"./trafic/trafic.module": [
		"./src/app/home/trafic/trafic.module.ts",
		"common",
		"trafic-trafic-module"
	],
	"./weather/weather-details/weather-details.module": [
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [],
        imports: [
            angularfire2__WEBPACK_IMPORTED_MODULE_8__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_13__["environment"].firebase),
            angularfire2_database__WEBPACK_IMPORTED_MODULE_9__["AngularFireDatabaseModule"],
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"],
...
let AuthService = class AuthService {
    constructor(afAuth, router) {
        ...
        this.userName = '';
        this.isLogged = false;
        this.uid = this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(authState => {
            if (!authState) {
                return null;
            }
            else {
    ...
    logOut() {
        this.afAuth.auth.signOut().then(abc => { this.router.navigateByUrl('/auth'); });
    }
    navigate() {
...
AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [angularfire2_auth__WEBPACK_IMPORTED_MODULE_1__["AngularFireAuth"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]])
], AuthService);
...
const environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyAWBF4kxMGp3a0c9PoHShE5RT60fVOmvBs",
        authDomain: "ionweather-9c1a5.firebaseapp.com",
        databaseURL: "https://ionweather-9c1a5.firebaseio.com",
        projectId: "ionweather-9c1a5",
        storageBucket: "ionweather-9c1a5.appspot.com",
        messagingSenderId: "584035635619",
        appId: "1:584035635619:web:1724c0e58702b48e9c0a16",
        measurementId: "G-F80K72G8B8"
    }
};
/*
...
module.exports = __webpack_require__(/*! /var/www/html/ionWeather2.0/ionWeatherApp-1/src/main.ts */"./src/main.ts");
