...
var AutoComplateService = /** @class */ (function () {
    function AutoComplateService(http) {
        this.http = http;
        this.apiKey = 'AIzaSyADtYqSYIWJ5ZBU160TZH6rkLkhK_vboh8';
    }
    AutoComplateService.prototype.autoComplate = function (area) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
            .set("input", area)
            .set("key", this.apiKey);
        return this.http.get("https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/autocomplete/json?", { params: params });
    };
    AutoComplateService.prototype.latlngbyPlaceId = function (placeId) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
            .set("place_id", placeId)
            .set("key", this.apiKey);
        return this.http.get("https://maps.googleapis.com/maps/api/geocode/json?", { params: params });
    };
    AutoComplateService.ctorParameters = function () { return [
...
var LocatorPageModule = /** @class */ (function () {
    function LocatorPageModule() {
    }
...
var LocatorPage = /** @class */ (function () {
    function LocatorPage(router, placesservice, autocomplateService) {
        this.router = router;
    ...
    LocatorPage.prototype.autocomplatePridiction = function (event, setTO) {
        ...
        if (setTO == 'work') {
            this.werkPridiction = this.autocomplateService.autoComplate(event['target'].value)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (x) { return x['predictions']; }));
        }
        else {
    ...
    LocatorPage.prototype.setLocation = function (pridiction, placeId, text, setName) {
        ...
        if (setName == 'work') {
            ...
            this.autocomplateService.latlngbyPlaceId(placeId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (x) {
                var _a;
                return [(_a = {}, _a[text] = [x['results'][0].geometry][0].location, _a.location = pridiction, _a)];
            }))
    ...
    LocatorPage.prototype.navigateHome = function () {
        this.router.navigateByUrl('/home/tabs/places');
    };
    LocatorPage.ctorParameters = function () { return [
...
//# sourceMappingURL=locator-locator-module-es5.js.map