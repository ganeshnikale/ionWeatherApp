...
var WeatherDetailsPageModule = /** @class */ (function () {
    function WeatherDetailsPageModule() {
    }
    ...
    return WeatherDetailsPageModule;
}());
...
var WeatherDetailsPage = /** @class */ (function () {
    function WeatherDetailsPage(weatherservice, httpactive) {
        this.weatherservice = weatherservice;
        this.httpactive = httpactive;
        this.weatherDetails = [];
    }
    WeatherDetailsPage.prototype.ngOnInit = function () {
    };
    WeatherDetailsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=weather-weather-details-weather-details-module-es5.js.map