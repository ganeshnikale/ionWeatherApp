...
var PlacesPage = /** @class */ (function () {
    ...
    PlacesPage.prototype.getWorkPlacesData = function (worklocation, latlan, storeData, lookingfor) {
        var _this = this;
        this.loadingCtrl.create({
            message: 'please wait',
            keyboardClose: true,
        }).then(function (lodingEl) {
            lodingEl.present();
            _this.placesservice.getLatLongs(worklocation)
                .subscribe(function (abc) {
                latlan = abc['results'][0].geometry.location;
                _this.workLocation = _this.placesservice.workLocation;
                _this.homeLocation = _this.placesservice.homeLocation;
                _this.workLocation = _this.placesservice.workLocation;
                _this.homeLocation = _this.placesservice.homeLocation;
                var data = _this.placesservice.getPlaces1(latlan.lat, latlan.lng, lookingfor);
                data.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (x) {
                    return x['results'].filter(function (val) { return val.photos !== undefined; });
                })).subscribe(function (abc) {
                    storeData.push(abc);
                });
            });
