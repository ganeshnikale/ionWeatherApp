...
var DistanceMatrixService = /** @class */ (function () {
    ...
    DistanceMatrixService.prototype.getDistance = function (homeLatLng, worklatLng) {
...
var TraficPage = /** @class */ (function () {
    ...
    TraficPage.prototype.ngOnInit = function () {
        var _this = this;
        this.distancematrixService.getDistance(this.worklatLng, this.homeLatLng).subscribe(function (abc) {
