...
var WeatherPage = /** @class */ (function () {
    ...
    WeatherPage.prototype.getPlacesweatherData = function (worklocation, latlan, storeData) {
        var _this = this;
        this.placesservice.getLatLongs(worklocation)
            .subscribe(function (abc) {
            latlan = abc['results'][0].geometry.location;
            var data = _this.weatherservice.getWeatherData(latlan.lat, latlan.lng);
            data.subscribe(function (abc) {
                storeData.push(abc);
            });
        });
    };
