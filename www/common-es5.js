...
/***/ "./src/app/home/WeatherService.ts":
/*!****************************************!*\
  !*** ./src/app/home/WeatherService.ts ***!
  \****************************************/
...
var WeatherService = /** @class */ (function () {
    function WeatherService(http) {
        this.http = http;
        this.WeatherDataMaster = [];
        this.WeatherDetails = [];
        this.homeLat = '';
        this.homeLng = '';
        this.enterLocation = '';
    }
    WeatherService.prototype.getWeatherData = function (lat, lng) {
        console.log(lat, lng);
...
var PlacesService = /** @class */ (function () {
    function PlacesService(http, weatherservice, afdb) {
        this.http = http;
    ...
    PlacesService.prototype.getPlaces1 = function (lat, lng, lookingfor) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set("type", lookingfor)
            .set("radius", "1500")
            .set("key", this.apiKey);
        return this.http.get("https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=" + lat + "," + lng, { params: params });
    };
    PlacesService.prototype.getPlaceDetails = function (place_id) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            ...
            .set("key", this.apiKey);
        return this.http.get("https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/details/json?", { params: params });
    };
