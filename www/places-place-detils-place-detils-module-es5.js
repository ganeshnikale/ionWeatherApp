...
var PlaceDetilsPageModule = /** @class */ (function () {
    function PlaceDetilsPageModule() {
    }
...
var PlaceDetilsPage = /** @class */ (function () {
    function PlaceDetilsPage(activerouter, http, placesservice) {
    ...
    PlaceDetilsPage.prototype.ngOnInit = function () {
        var _this = this;
        this.activerouter.queryParamMap.subscribe(function (abc) {
            console.log(abc.get('place_id'));
            _this.placesservice.getPlaceDetails(abc.get('place_id')).subscribe(function (data) {
                _this.placesDetails.push(data['result']);
                console.log(_this.placesDetails);
            });
        });
    };
    PlaceDetilsPage.prototype.addToFavorite = function (favoritePlaceId) {
        this.placesservice.setfavoritePlace(favoritePlaceId);
    };
    PlaceDetilsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=places-place-detils-place-detils-module-es5.js.map